define(["Game/Block"], function (Block) {
    ...
    Layer.prototype.create = function() {
        ...
        this.API.createPlatform(3*tile, 6*tile, tile, 13*tile, this.main.fullMetalBlock);
        this.API.createPlatform(4*tile, 7*tile, tile, 11*tile, this.main.fullMetalBlock);
        ...
        this.API.createPlatform(32*tile, 7*tile, 3*tile, tile, this.main.fullMetalBlock);
        this.API.createPlatform(43*tile, 7*tile, 3*tile, tile, this.main.fullMetalBlock);
